-- ============================================
-- DATABASE FUNCTION: Submit Answer Securely
-- ============================================
-- This function allows the game service to update player scores
-- while preventing direct score manipulation by players
-- ============================================
...
'Securely submit an answer and update player score. Runs with elevated privileges to bypass RLS restrictions while maintaining security.';
