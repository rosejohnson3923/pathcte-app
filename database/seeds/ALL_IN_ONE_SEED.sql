...
-- Verify careers
SELECT COUNT(*) as careers_inserted FROM public.careers WHERE is_verified = true;
...
BEGIN
  ...
  RAISE NOTICE 'Pathkeys inserted successfully';
END $$;

-- Verify pathkeys
SELECT COUNT(*) as pathkeys_inserted FROM public.pathkeys WHERE is_active = true;

-- ============================================
-- PART 3: QUESTION SETS & QUESTIONS (3 sets, 25 questions)
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE 'Question sets created: Set1 (%), Set2 (%), Set3 (%)', set1_id, set2_id, set3_id;
END $$;
