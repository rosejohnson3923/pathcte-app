...
-- ============================================
-- Question Set 1: Introduction to Healthcare Careers
-- ============================================
...
SELECT
  ...
  question_data.time_limit_seconds,
...
FROM new_set, (
  ...
  question_text, question_type, options, time_limit_seconds,
  points, order_index, difficulty
);

-- ============================================
-- Question Set 2: Exploring Technology Jobs
-- ============================================
...
-- ============================================
-- Question Set 3: Creative Careers for Artists
-- ============================================
...
-- ============================================
-- Question Set 4: Careers Helping Others
-- ============================================
...
-- ============================================
-- Question Set 5: Building Things: Construction & Trades
-- ============================================
...
-- ============================================
-- Question Set 6: Science Careers for Curious Minds
-- ============================================
...
-- ============================================
-- Question Set 7: Business & Money Careers
-- ============================================
...
-- ============================================
-- Question Set 8: Working with Animals & Nature
-- ============================================
...
-- ============================================
-- Question Set 9: Healthcare Careers Fundamentals
-- ============================================
...
-- ============================================
-- Question Set 10: Technology & Engineering Basics
-- ============================================
...
-- ============================================
-- Question Set 11: Business & Finance Careers
-- ============================================
...
-- ============================================
-- Question Set 12: Creative Arts & Design
-- ============================================
...
-- ============================================
-- Question Set 13: Science & Research Careers
-- ============================================
...
-- ============================================
-- Question Set 14: Education & Teaching
-- ============================================
...
-- ============================================
-- Question Set 15: Public Service & Law
-- ============================================
...
-- ============================================
-- Question Set 16: Environmental & Agriculture
-- ============================================
...
-- ============================================
-- Question Set 17: Skilled Trades & Construction
-- ============================================
...
-- ============================================
-- Question Set 18: Hospitality & Service Industry
-- ============================================
