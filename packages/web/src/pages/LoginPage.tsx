...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-500 via-teal-500 to-purple-600 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
          <h1 className="text-2xl font-display font-bold text-center mb-6 text-gray-900">
            Welcome Back
          </h1>
