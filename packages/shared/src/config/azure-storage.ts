 ...
 * Location: East US (co-located with Azure AI Foundry)
...
export const getAzureStorageConfig = (): AzureStorageConfig => {
  const config: AzureStorageConfig = {
    accountName: getViteEnv('VITE_AZURE_STORAGE_ACCOUNT') || 'pathctestore',
    storageUrl: getViteEnv('VITE_AZURE_STORAGE_URL') || 'https://pathctestore.blob.core.windows.net',
